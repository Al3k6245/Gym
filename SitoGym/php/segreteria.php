...
<div class="hoversection small" id="nuovoAllenamento" style="display: none">
  ...
  <!------------------------------------------------------- MENU DI NAVIGAZIONE LATERALE ---------------------------------------------------------------->
    ...
    <nav data-w-id="93085ae0-f7f2-eb6d-a80c-8ff237c72caf" class="menu-icone"><a href="SddUsers.php" class="menu-sezioni logout w-button"></a><a href="segreteria.php" class="menu-sezioni _0 w-button w--current"></a><a href="AddUsers.php" class="menu-sezioni _3 w-button"></a></nav>
